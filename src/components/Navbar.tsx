    ...
    return (
        <nav className='w-full py-4 px-6 md:px-32 bg-transparent font-jakarta backdrop-blur-xl fixed z-30 top-0 left-0 min-h-10 border-b-2 border-gray-100'>
                  <div className='container mx-auto flex flex-row items-center justify-between'>
                    ...
                    <ul className='hidden md:flex flex-row items-center gap-4 font-medium text-sm text-[#475569]'>
                    ...
                    <div className='flex flex-row items-center justify-center gap-4 text-[9px] md:text-sm font-semibold'>
