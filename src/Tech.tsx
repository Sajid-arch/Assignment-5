    ...
    return (
            ...
            <section className="px-6 pb-30 md:px-15 lg:px-30">
                        <div className="container mx-auto">
                            <h2 className="font-extrabold font-inter pb-4 text-2xl md:text-3xl lg:text-4xl text-[#0F172A]">Explore the <span className="tech-heading-gradient">Technologies</span></h2>
                            ...
                            <div className="pt-15 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-4 lg:gap-6">
